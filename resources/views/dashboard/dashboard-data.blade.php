                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td>
                            <div>
                                ...
                                <a href="{{ route('receipt.print', ['type' => $receipt->type_id, 'receipt' => $receipt->id]) }}" target="_blank">
                                    <x-buttons.small-button class="!bg-green-500 !hover:bg-green-700 !focus:bg-green-700 !active:bg-green-900">
